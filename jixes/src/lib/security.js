const rolePermissions = {
  "Super administrator": ["*"],
  "Operations manager": ["Dashboard", "Customers", "Products", "GPS Trackers", "Screening", "Support Cases", "Wi-Fi Packages", "Alerts", "Reports"],
  "Finance officer": ["Dashboard", "Customers", "Payments", "Commissions", "Wi-Fi Packages", "Reports"],
