...
const trackerView = read("jixes/src/components/TrackerView.jsx");
...
assert.match(apiFunction, /providerSummary/, "route history must expose Tramigo trip status details");
...
assert.match(apiFunction, /Your one-time verification code is \$\{code\}/, "the approval notification must visibly include the six-digit code");
